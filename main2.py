...
if odk_token:
    ...
    st.subheader(f"Total de Respostas: {len(df)}")
    ...
    st.subheader("Evolução das respostas por Município: respostas ao longo do tempo")
    ...
    fig_line.update_layout(xaxis_title="Data", yaxis_title="Número de Respostas")
    st.plotly_chart(fig_line, use_container_width=True)

    # --- Gráfico de barras para comparação entre municípios ---
    st.subheader(f"Distribuição de respostas por Município: {titulo}")
